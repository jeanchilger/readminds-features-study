...
class VideoWrapper:
    """Class that wraps pyVHR Video and provides a basic documentation
    regarding parameters and methods. VideoWrapper can be used for
    video assessment (ROI methods and thresholds evaluation).
    ...
    def __init__(
        ...
        Args:
            ...
            rect_regions (list, optional): List of retangular regions
                to be extracted from the face, e.g ['forehead',
