...
class ICAEstimator(BaseEstimator):
    ...
    """Defines a wrapper for heart rate estimator
    based in Idependent Component Analysis (ICA)
    of remote photoplethysmography (rPPG) data
    ...
    def run_offline(self):
        estimation = self._ica.runOffline(endTime=self._end_time,
